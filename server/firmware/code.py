...
# ── SEPTA logo — 16×11 px, RGB565, G/B channels swapped for panel hardware ────
...
SEPTA_LOGO = (
    0x0000, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0000,
    0x0568, 0x0568, 0x0568, 0x0568, 0xFFFF, 0xFFFF, 0xFFFF, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568,
    0x0568, 0x0568, 0x0568, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568,
    0x0568, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568, 0x0568,
    0xFFFF, 0xFFFF, 0xFFFF, 0xE007, 0xE007, 0xFFFF, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0x0568, 0x0568, 0x0568, 0x0568, 0xFFFF, 0xFFFF,
    0xFFFF, 0xFFFF, 0xFFFF, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0xFFFF, 0xE007, 0xFFFF, 0x0568, 0x0568, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
    0xFFFF, 0xE007, 0xE007, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0568, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
    0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xE007, 0xE007,
    0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xE007, 0xE007, 0xE007,
    0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xFFFF, 0xFFFF, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007,
    0x0000, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x0000,
)
...
class TrainDisplay:
    ...
    def _build_septa_logo(self):
        """Build the 16×11 SEPTA logo TileGrid in RAM from hardcoded RGB565 data.
        No BMP file needed on CIRCUITPY — logo is embedded directly in firmware.
        """
        try:
            bm = displayio.Bitmap(16, 11, 65536)
            for i, val in enumerate(SEPTA_LOGO):
                bm[i % 16, i // 16] = val
            converter = displayio.ColorConverter(
                input_colorspace=displayio.Colorspace.RGB565)
            return displayio.TileGrid(bm, pixel_shader=converter, x=0, y=10)
