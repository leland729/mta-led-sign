...
//   ✅ Verified: G, 7, ACE
//   ✅ Verified: G, 7, ACE, BDFM, NQRW, 123, 456, JZ
...
const BDFM_LINE_STATIONS = [
  ...
  { stop_id: 'D14', stop_name: '7 Av',                            routes: ['B', 'D']                    },
  ...
  { stop_id: 'D15', stop_name: '47-50 Sts-Rockefeller Ctr',       routes: ['B', 'D', 'F', 'M']          },
  { stop_id: 'D16', stop_name: '42 St-Bryant Pk',                 routes: ['B', 'D', 'F', 'M']          },
  { stop_id: 'D17', stop_name: '34 St-Herald Sq',                 routes: ['B', 'D', 'F', 'M', 'N', 'Q', 'R', 'W'] },
  { stop_id: 'D18', stop_name: '23 St',                           routes: ['F', 'M']                    },
  { stop_id: 'D19', stop_name: '14 St',                           routes: ['F', 'M']                    },
  ...
  // Brighton Beach branch (B/D Brooklyn)
  { stop_id: 'D24', stop_name: 'Atlantic Av-Barclays Ctr',        routes: ['B', 'D', 'N', 'Q', 'R']    },
  { stop_id: 'D25', stop_name: '7 Av',                            routes: ['B', 'Q']                    },
  { stop_id: 'D26', stop_name: 'Prospect Park',                   routes: ['B', 'Q']                    },
  { stop_id: 'D27', stop_name: 'Parkside Av',                     routes: ['B', 'Q']                    },
  { stop_id: 'D28', stop_name: 'Church Av',                       routes: ['B', 'Q']                    },
  { stop_id: 'D29', stop_name: 'Beverley Rd',                     routes: ['B', 'Q']                    },
  { stop_id: 'D30', stop_name: 'Cortelyou Rd',                    routes: ['B', 'Q']                    },
  { stop_id: 'D31', stop_name: 'Newkirk Plaza',                   routes: ['B', 'Q']                    },
  { stop_id: 'D32', stop_name: 'Avenue H',                        routes: ['B', 'Q']                    },
  { stop_id: 'D33', stop_name: 'Avenue J',                        routes: ['B', 'Q']                    },
  { stop_id: 'D34', stop_name: 'Avenue M',                        routes: ['B', 'Q']                    },
  { stop_id: 'D35', stop_name: 'Kings Hwy',                       routes: ['B', 'Q']                    },
  { stop_id: 'D37', stop_name: 'Avenue U',                        routes: ['B', 'Q']                    },
  { stop_id: 'D38', stop_name: 'Neck Rd',                         routes: ['B']                         },
  { stop_id: 'D39', stop_name: 'Sheepshead Bay',                  routes: ['B', 'Q']                    },
  { stop_id: 'D40', stop_name: 'Brighton Beach',                  routes: ['B', 'Q']                    },
  { stop_id: 'D41', stop_name: 'Ocean Pkwy',                      routes: ['B', 'Q']                    },
  { stop_id: 'D42', stop_name: 'W 8 St-NY Aquarium',              routes: ['B', 'Q']                    },
  { stop_id: 'D43', stop_name: 'Coney Island-Stillwell Av',       routes: ['D', 'F', 'N', 'Q']          },
  // F/M train Queens (IND Queens Blvd) — note: F/M use BDFM feed; E uses ACE feed
  { stop_id: 'F01', stop_name: 'Jamaica-179 St',                  routes: ['F']                         },
  { stop_id: 'F03', stop_name: 'Parsons Blvd',                    routes: ['E', 'F']                    },
  { stop_id: 'F05', stop_name: 'Briarwood',                       routes: ['E', 'F']                    },
  { stop_id: 'F06', stop_name: 'Kew Gardens-Union Tpke',          routes: ['E', 'F']                    },
  ...
  { stop_id: 'G21', stop_name: 'Queens Plaza',                    routes: ['E', 'M', 'R']               },
  { stop_id: 'F09', stop_name: 'Court Sq-23 St',                  routes: ['E', 'M']                    },
  // F train unique Manhattan stops (63 St / 2 Av connections)
  { stop_id: 'F11', stop_name: 'Lexington Av/53 St',              routes: ['F']                         },
  { stop_id: 'F12', stop_name: '5 Av/53 St',                      routes: ['F']                         },
  { stop_id: 'F14', stop_name: '2 Av',                            routes: ['F']                         },
  { stop_id: 'F15', stop_name: 'Delancey St-Essex St',            routes: ['F', 'J', 'M', 'Z']          },
  { stop_id: 'F16', stop_name: 'East Broadway',                   routes: ['F']                         },
  // F train Brooklyn
  { stop_id: 'F18', stop_name: 'York St',                         routes: ['F']                         },
  { stop_id: 'F20', stop_name: 'Bergen St',                       routes: ['F', 'G']                    },
  { stop_id: 'F21', stop_name: 'Carroll St',                      routes: ['F', 'G']                    },
  { stop_id: 'F22', stop_name: 'Smith-9 Sts',                     routes: ['F', 'G']                    },
  { stop_id: 'F23', stop_name: '4 Av-9 St',                       routes: ['F', 'G', 'R']               },
  { stop_id: 'F24', stop_name: '7 Av',                            routes: ['F']                         },
  { stop_id: 'F25', stop_name: '15 St-Prospect Park',             routes: ['F', 'G']                    },
  { stop_id: 'F26', stop_name: 'Fort Hamilton Pkwy',              routes: ['F', 'G']                    },
  { stop_id: 'F27', stop_name: 'Church Av',                       routes: ['F']                         },
  { stop_id: 'F29', stop_name: 'Ditmas Av',                       routes: ['F']                         },
  { stop_id: 'F30', stop_name: '18 Av',                           routes: ['F']                         },
  { stop_id: 'F31', stop_name: 'Avenue I',                        routes: ['F']                         },
  { stop_id: 'F32', stop_name: 'Bay Pkwy',                        routes: ['F']                         },
  { stop_id: 'F33', stop_name: 'Avenue N',                        routes: ['F']                         },
  { stop_id: 'F34', stop_name: 'Avenue P',                        routes: ['F']                         },
  { stop_id: 'F35', stop_name: 'Kings Hwy',                       routes: ['F']                         },
  { stop_id: 'F36', stop_name: 'Avenue U',                        routes: ['F']                         },
  { stop_id: 'F38', stop_name: 'Avenue X',                        routes: ['F']                         },
  { stop_id: 'F39', stop_name: 'Neptune Av',                      routes: ['F']                         },
  // M train (Middle Village branch)
  { stop_id: 'M01', stop_name: 'Middle Village-Metropolitan Av',  routes: ['M']                         },
  { stop_id: 'M04', stop_name: 'Fresh Pond Rd',                   routes: ['M']                         },
  { stop_id: 'M05', stop_name: 'Forest Av',                       routes: ['M']                         },
  { stop_id: 'M06', stop_name: 'Seneca Av',                       routes: ['M']                         },
  { stop_id: 'M08', stop_name: 'Myrtle-Wyckoff Avs',              routes: ['L', 'M']                    },
  { stop_id: 'M09', stop_name: 'Knickerbocker Av',                routes: ['M']                         },
  { stop_id: 'M10', stop_name: 'Central Av',                      routes: ['M']                         },
  { stop_id: 'M11', stop_name: 'Myrtle Av',                       routes: ['J', 'M', 'Z']               },
  { stop_id: 'M12', stop_name: 'Flushing Av',                     routes: ['J', 'M', 'Z']               },
  { stop_id: 'M13', stop_name: 'Lorimer St',                      routes: ['J', 'M', 'Z']               },
  { stop_id: 'M14', stop_name: 'Hewes St',                        routes: ['J', 'M', 'Z']               },
  { stop_id: 'M16', stop_name: 'Marcy Av',                        routes: ['J', 'M', 'Z']               },
...
const NQRW_LINE_STATIONS = [
  ...
  { stop_id: 'R34', stop_name: 'Prospect Av',                     routes: ['R']                         },
  { stop_id: 'R35', stop_name: '25 St',                           routes: ['R']                         },
  { stop_id: 'R36', stop_name: '36 St',                           routes: ['D', 'N', 'R']               },
  { stop_id: 'R39', stop_name: '45 St',                           routes: ['R']                         },
  { stop_id: 'R40', stop_name: '53 St',                           routes: ['R']                         },
  { stop_id: 'R41', stop_name: '59 St',                           routes: ['N', 'R']                    },
  { stop_id: 'R42', stop_name: 'Bay Ridge Av',                    routes: ['R']                         },
  { stop_id: 'R43', stop_name: '77 St',                           routes: ['R']                         },
  { stop_id: 'R44', stop_name: '86 St',                           routes: ['R']                         },
  { stop_id: 'R45', stop_name: 'Bay Ridge-95 St',                 routes: ['R']                         },
  // N/Q Brighton Beach / Coney Island (Brooklyn)
  { stop_id: 'N02', stop_name: '8 Av',                            routes: ['N']                         },
  { stop_id: 'N03', stop_name: 'Fort Hamilton Pkwy',              routes: ['N']                         },
  { stop_id: 'N04', stop_name: 'New Utrecht Av',                  routes: ['N']                         },
  { stop_id: 'N05', stop_name: '18 Av',                           routes: ['N']                         },
  { stop_id: 'N06', stop_name: '20 Av',                           routes: ['N']                         },
  { stop_id: 'N07', stop_name: 'Bay Pkwy',                        routes: ['N']                         },
  { stop_id: 'N08', stop_name: 'Kings Hwy',                       routes: ['N']                         },
  { stop_id: 'N09', stop_name: 'Avenue U',                        routes: ['N']                         },
  { stop_id: 'N10', stop_name: '86 St',                           routes: ['N']                         },
  // Q train Second Av extension stops (upper Manhattan)
  { stop_id: 'Q01', stop_name: 'Canal St',                        routes: ['Q']                         },
  { stop_id: 'Q03', stop_name: '72 St',                           routes: ['Q']                         },
  { stop_id: 'Q04', stop_name: '86 St',                           routes: ['Q']                         },
  { stop_id: 'Q05', stop_name: '96 St',                           routes: ['Q']                         },
  { stop_id: 'D43', stop_name: 'Coney Island-Stillwell Av',       routes: ['D', 'F', 'N', 'Q']          },
];
...
const LINE_123_STATIONS = [
  // 1 train (IRT Broadway-7th Av, Manhattan)
  ...
  { stop_id: '108', stop_name: '207 St',                          routes: ['1']                         },
  { stop_id: '109', stop_name: 'Dyckman St',                      routes: ['1']                         },
  { stop_id: '110', stop_name: '191 St',                          routes: ['1']                         },
  { stop_id: '111', stop_name: '181 St',                          routes: ['1']                         },
  { stop_id: '112', stop_name: '168 St-Washington Hts',           routes: ['1', 'A', 'C']               },
  { stop_id: '113', stop_name: '157 St',                          routes: ['1']                         },
  { stop_id: '114', stop_name: '145 St',                          routes: ['1']                         },
  { stop_id: '115', stop_name: '137 St-City College',             routes: ['1']                         },
  { stop_id: '116', stop_name: '125 St',                          routes: ['1']                         },
  { stop_id: '117', stop_name: '116 St-Columbia University',      routes: ['1']                         },
  { stop_id: '118', stop_name: 'Cathedral Pkwy (110 St)',         routes: ['1']                         },
  { stop_id: '119', stop_name: '103 St',                          routes: ['1']                         },
  { stop_id: '120', stop_name: '96 St',                           routes: ['1']                         },
  { stop_id: '121', stop_name: '86 St',                           routes: ['1']                         },
  { stop_id: '122', stop_name: '79 St',                           routes: ['1']                         },
  { stop_id: '123', stop_name: '72 St',                           routes: ['1', '2', '3']               },
  { stop_id: '124', stop_name: '66 St-Lincoln Center',            routes: ['1']                         },
  { stop_id: '125', stop_name: '59 St-Columbus Circle',           routes: ['1', 'A', 'B', 'C', 'D']    },
  { stop_id: '126', stop_name: '50 St',                           routes: ['1']                         },
  ...
  { stop_id: '133', stop_name: 'Christopher St-Stonewall',        routes: ['1']                         },
  ...
  { stop_id: '138', stop_name: 'WTC Cortlandt',                   routes: ['1']                         },
  { stop_id: '139', stop_name: 'Rector St',                       routes: ['1']                         },
  { stop_id: '142', stop_name: 'South Ferry',                     routes: ['1']                         },
  ...
  { stop_id: '221', stop_name: '3 Av-149 St',                     routes: ['2', '5']                    },
  ...
  { stop_id: '227', stop_name: '110 St-Malcolm X Plaza',          routes: ['2', '3']                    },
  // 2/3 Brooklyn (IRT Eastern Pkwy / Clark St tunnel)
  { stop_id: '228', stop_name: 'Park Place',                      routes: ['2', '3']                    },
  { stop_id: '229', stop_name: 'Fulton St',                       routes: ['2', '3']                    },
  { stop_id: '230', stop_name: 'Wall St',                         routes: ['2', '3']                    },
  { stop_id: '231', stop_name: 'Clark St',                        routes: ['2', '3']                    },
  { stop_id: '232', stop_name: 'Borough Hall',                    routes: ['2', '3']                    },
  { stop_id: '233', stop_name: 'Hoyt St',                         routes: ['2', '3']                    },
  { stop_id: '234', stop_name: 'Nevins St',                       routes: ['2', '3']                    },
  { stop_id: '235', stop_name: 'Atlantic Av-Barclays Ctr',        routes: ['2', '3', '4', '5', 'B', 'D', 'N', 'Q', 'R'] },
  { stop_id: '236', stop_name: 'Bergen St',                       routes: ['2', '5']                    },
  { stop_id: '237', stop_name: 'Grand Army Plaza',                routes: ['2', '5']                    },
  { stop_id: '238', stop_name: 'Eastern Pkwy-Brooklyn Museum',    routes: ['2', '5']                    },
  { stop_id: '239', stop_name: 'Franklin Av-Medgar Evers College',routes: ['2', '5']                    },
  { stop_id: '241', stop_name: 'President St-Medgar Evers College',routes: ['2', '5']                   },
  { stop_id: '242', stop_name: 'Sterling St',                     routes: ['2', '5']                    },
  { stop_id: '243', stop_name: 'Winthrop St',                     routes: ['2', '5']                    },
  { stop_id: '244', stop_name: 'Church Av',                       routes: ['2', '5']                    },
  { stop_id: '245', stop_name: 'Beverly Rd',                      routes: ['2', '5']                    },
  { stop_id: '246', stop_name: 'Newkirk Av-Little Haiti',         routes: ['2', '5']                    },
  { stop_id: '247', stop_name: 'Flatbush Av-Brooklyn College',    routes: ['2', '5']                    },
  // 3 train Crown Heights / New Lots branch
  { stop_id: '248', stop_name: 'Nostrand Av',                     routes: ['2', '5']                    },
  { stop_id: '249', stop_name: 'Kingston Av',                     routes: ['3', '4']                    },
  { stop_id: '250', stop_name: 'Crown Hts-Utica Av',              routes: ['3', '4']                    },
  { stop_id: '251', stop_name: 'Sutter Av-Rutland Rd',            routes: ['3']                         },
  { stop_id: '252', stop_name: 'Saratoga Av',                     routes: ['3']                         },
  { stop_id: '253', stop_name: 'Rockaway Av',                     routes: ['3']                         },
  { stop_id: '254', stop_name: 'Junius St',                       routes: ['3']                         },
  { stop_id: '255', stop_name: 'Pennsylvania Av',                 routes: ['3']                         },
  { stop_id: '256', stop_name: 'Van Siclen Av',                   routes: ['3']                         },
  { stop_id: '257', stop_name: 'New Lots Av',                     routes: ['3']                         },
];
...
const LINE_456_STATIONS = [
  ...
  { stop_id: '408', stop_name: '183 St',                          routes: ['4']                         },
  ...
  { stop_id: '629', stop_name: '59 St',                           routes: ['4', '5', '6']               },
  ...
  { stop_id: '634', stop_name: '23 St-Baruch College',            routes: ['6']                         },
  ...
  // 4/5 lower Manhattan (IRT Lexington Av downtown)
  { stop_id: '418', stop_name: 'Fulton St',                       routes: ['2', '3', '4', '5', 'A', 'C', 'J', 'Z'] },
  { stop_id: '419', stop_name: 'Wall St',                         routes: ['2', '3', '4', '5']          },
  { stop_id: '420', stop_name: 'Bowling Green',                   routes: ['4', '5']                    },
  { stop_id: '423', stop_name: 'Borough Hall',                    routes: ['4', '5']                    },
  // 4/5 Brooklyn (Eastern Pkwy / New Lots — shared IDs with 2/3 line)
  { stop_id: '249', stop_name: 'Kingston Av',                     routes: ['3', '4']                    },
  { stop_id: '250', stop_name: 'Crown Hts-Utica Av',              routes: ['3', '4']                    },
  { stop_id: '251', stop_name: 'Sutter Av-Rutland Rd',            routes: ['4']                         },
  { stop_id: '252', stop_name: 'Saratoga Av',                     routes: ['4']                         },
  { stop_id: '253', stop_name: 'Rockaway Av',                     routes: ['4']                         },
  { stop_id: '254', stop_name: 'Junius St',                       routes: ['4']                         },
  { stop_id: '255', stop_name: 'Pennsylvania Av',                 routes: ['4']                         },
  { stop_id: '256', stop_name: 'Van Siclen Av',                   routes: ['4']                         },
  { stop_id: '257', stop_name: 'New Lots Av',                     routes: ['4', '5']                    },
  // 6 train Bronx (Pelham Bay Park branch)
  ...
  { stop_id: '610', stop_name: 'Morrison Av-Soundview',           routes: ['6']                         },
  ...
  { stop_id: '618', stop_name: 'Brook Av',                        routes: ['6']                         },
  { stop_id: '619', stop_name: '3 Av-138 St',                     routes: ['6']                         },
];

// ─── J/Z lines — BMT Nassau St ────────────────────────────────────────────────
// ✅ Verified against gtfs_subway/stops.txt (Feb 19 2026)
const JZ_LINE_STATIONS = [
  // J/Z Queens (Jamaica Ave / Richmond Hill)
  { stop_id: 'G05', stop_name: 'Jamaica Center-Parsons/Archer',   routes: ['E', 'J', 'Z']               },
  { stop_id: 'G06', stop_name: 'Sutphin Blvd-Archer Av-JFK',      routes: ['E', 'J', 'Z']               },
  { stop_id: 'J12', stop_name: '121 St',                          routes: ['J', 'Z']                    },
  { stop_id: 'J13', stop_name: '111 St',                          routes: ['J', 'Z']                    },
  { stop_id: 'J14', stop_name: '104 St',                          routes: ['J', 'Z']                    },
  { stop_id: 'J15', stop_name: 'Woodhaven Blvd',                  routes: ['J', 'Z']                    },
  { stop_id: 'J16', stop_name: '85 St-Forest Pkwy',               routes: ['J', 'Z']                    },
  { stop_id: 'J17', stop_name: '75 St-Elderts Ln',                routes: ['J', 'Z']                    },
  { stop_id: 'J19', stop_name: 'Cypress Hills',                   routes: ['J', 'Z']                    },
  { stop_id: 'J20', stop_name: 'Crescent St',                     routes: ['J', 'Z']                    },
  { stop_id: 'J21', stop_name: 'Norwood Av',                      routes: ['J', 'Z']                    },
  { stop_id: 'J22', stop_name: 'Cleveland St',                    routes: ['J', 'Z']                    },
  { stop_id: 'J23', stop_name: 'Van Siclen Av',                   routes: ['J', 'Z']                    },
  { stop_id: 'J24', stop_name: 'Alabama Av',                      routes: ['J', 'Z']                    },
  { stop_id: 'J27', stop_name: 'Broadway Junction',               routes: ['A', 'C', 'J', 'Z', 'L']    },
  { stop_id: 'J28', stop_name: 'Chauncey St',                     routes: ['J', 'Z']                    },
  { stop_id: 'J29', stop_name: 'Halsey St',                       routes: ['J', 'Z']                    },
  { stop_id: 'J30', stop_name: 'Gates Av',                        routes: ['J', 'Z']                    },
  { stop_id: 'J31', stop_name: 'Kosciuszko St',                   routes: ['J']                         },
